...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SUPWANG', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'FOR AI', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-git-main-supwangyun-hotmailcom.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'SUPWANG, 博客', // 网站关键词 英文逗号隔开
